...
export const SFX_MAP: Record<SFXName, SoundDef> = {
  coinPlace: {
    ...
    category: 'gameplay',
    source: null, // require('../../assets/audio/sfx/coin_place.mp3'),
    volume: 1.0,
  },
  coinMove: {
    key: 'coinMove',
    ...
    category: 'gameplay',
    source: null, // require('../../assets/audio/sfx/coin_move.mp3'),
    volume: 0.8,
  },
  victory: {
    key: 'victory',
    ...
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/victory.mp3'),
    volume: 1.0,
  },
  defeat: {
    key: 'defeat',
    ...
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/defeat.mp3'),
    volume: 0.9,
  },
  timerWarning: {
    key: 'timerWarning',
    ...
    category: 'timer',
    source: null, // require('../../assets/audio/sfx/timer_warning.mp3'),
    volume: 0.7,
  },
  uiTap: {
    key: 'uiTap',
    ...
    category: 'ui',
    source: null, // require('../../assets/audio/sfx/ui_tap.mp3'),
    volume: 0.5,
  },
  uiBack: {
    key: 'uiBack',
    ...
    category: 'ui',
    source: null, // require('../../assets/audio/sfx/ui_back.mp3'),
    volume: 0.5,
  },
  matchFound: {
    key: 'matchFound',
    ...
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/match_found.mp3'),
    volume: 1.0,
  },
  gameStart: {
    key: 'gameStart',
    ...
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/game_start.mp3'),
    volume: 1.0,
  },
  turnChange: {
    key: 'turnChange',
    ...
    category: 'gameplay',
    source: null, // require('../../assets/audio/sfx/turn_change.mp3'),
    volume: 0.6,
  },
  combo: {
    key: 'combo',
    ...
    category: 'gameplay',
    source: null, // require('../../assets/audio/sfx/combo.mp3'),
    volume: 1.0,
  },
  error: {
    key: 'error',
    ...
    category: 'ui',
    source: null, // require('../../assets/audio/sfx/error.mp3'),
    volume: 0.6,
  },
  reward: {
    key: 'reward',
    ...
    descriptionJa: '報酬獲得',
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/reward.mp3'),
    volume: 1.0,
  },
  levelUp: {
    key: 'levelUp',
    ...
    category: 'feedback',
    source: null, // require('../../assets/audio/sfx/level_up.mp3'),
    volume: 1.0,
  },
  countdown321: {
    key: 'countdown321',
    ...
    category: 'timer',
    source: null, // require('../../assets/audio/sfx/countdown.mp3'),
    volume: 0.8,
  },
};
...
export const BGM_MAP: Record<BGMName, BGMDef> = {
  lobby: {
    ...
    source: null, // require('../../assets/audio/bgm/lobby.mp3'),
    volume: 0.6,
  },
  game1_coinboard: {
    key: 'game1_coinboard',
    ...
    source: null, // require('../../assets/audio/bgm/game1_coinboard.mp3'),
    volume: 0.5,
  },
  game2: {
    key: 'game2',
    ...
    source: null, // require('../../assets/audio/bgm/game2.mp3'),
    volume: 0.5,
  },
  game3: {
    key: 'game3',
    ...
    source: null, // require('../../assets/audio/bgm/game3.mp3'),
    volume: 0.5,
  },
  game4: {
    key: 'game4',
    ...
    source: null, // require('../../assets/audio/bgm/game4.mp3'),
    volume: 0.5,
  },
  game5: {
    key: 'game5',
    ...
    source: null, // require('../../assets/audio/bgm/game5.mp3'),
    volume: 0.5,
  },
  game6_quiz: {
    key: 'game6_quiz',
    ...
    source: null, // require('../../assets/audio/bgm/game6_quiz.mp3'),
    volume: 0.5,
  },
  battle: {
    key: 'battle',
    ...
    source: null, // require('../../assets/audio/bgm/battle.mp3'),
    volume: 0.6,
  },
  results: {
    key: 'results',
    ...
    source: null, // require('../../assets/audio/bgm/results.mp3'),
    volume: 0.5,
  },
};
